...
public class FansDetailActivity extends BaseActivity implements
...
//		String test_url = "http://www.tuling123.com/openapi/api?key=f6825cb333a2fc8a0205de98f79a724a&info="
//				+ encode_content;
		// Get请求发送用户userID，请求服务器返回用户关注的人头像
		String request_url = AppConstant.BaseURL + "?username="
				+ spUtil.getUserID();
		/*************************创建静态数据******************************/
		list.add("http://img.my.csdn.net/uploads/201505/30/1432982347_2668.jpg-thumb.jpg");
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
			long id) {
//		MyToast.hideToast();
//		MyToast.centerToast(FansDetailActivity.this, list.get(position));
		Intent intent = new Intent(FansDetailActivity.this,
				OtherActionActivity.class);
		if (0 != user_list.size()) {
			intent.putExtra("userId", user_list.get(position));
		}
